...
import { Button, Input, FormControl, Center, Box, SimpleGrid, VStack, Stack, Heading, Text } from '@chakra-ui/core'
import Nav from "./Nav"
          ...
          <SimpleGrid columns={[1, 1, 2]} spacing="40px">
            <Box borderWidth="1px" p={50} borderRadius={5}>
              ...
              <Input value={inputValueAdressVet} onChange={(e) => {setInputValueAdressVet(e.currentTarget.value)}}
                ...
                <Button onClick={handleOnClickApproveVet} my={10} colorScheme="teal" textTransform='uppercase'>Approuve</Button>
              </Center>
            </Box>
